...
inputs:
  ...
  - id: variants_to_table_fields
    ...
    'sbg:x': 0
    'sbg:y': 1391
  - id: variants_to_table_genotype_fields
    type: 'string[]?'
    default:
      - GT
      - AD
  ...
  - id: scatter_count
    type: int
    'sbg:x': 0.7650498747825623
    'sbg:y': 2253.5263671875
outputs:
  ...
  - id: final_filtered_vcf
    ...
    secondaryFiles:
      - .tbi
    'sbg:x': 4186.3369140625
    'sbg:y': 1444.5
  - id: final_tsv
    outputSource:
      - add_vep_fields_to_table/annotated_variants_tsv
    type: File
    'sbg:x': 4751.40673828125
    'sbg:y': 1391
  - id: final_vcf
    outputSource:
      - index/indexed_vcf
...
steps:
  ...
  - id: add_tumor_bam_readcount_to_vcf
    ...
    'sbg:x': 2407.288330078125
    'sbg:y': 1537.5
  - id: add_vep_fields_to_table
    in:
      - id: tsv
        source: variants_to_table/variants_tsv
      - id: vcf
        source: annotated_filter_index/indexed_vcf
      - id: vep_fields
        source:
          - vep_to_table_fields
    out:
      - id: annotated_variants_tsv
    run: ../tools/add_vep_fields_to_table.cwl
    label: add VEP annotation to report
    'sbg:x': 4464.9892578125
    'sbg:y': 1377
